# ILS-SUMM
This repo contains a python implementation of the paper - [ILS-SUMM: Iterated Local Search for Unsupervised Video Summarization](https://arxiv.org/abs/1912.03650) (accepted to ICPR 2020).
